 ...
 */
public class GPUImageInvertMonochromeFilter extends GPUImageFilter {
    public static final String MONOCHROME_FRAGMENT_SHADER = "" +
            ...
            " 	lowp vec4 outputMono = vec4( mix(textureColor.rgb, outputColor.rgb, intensity), textureColor.a);\n" +
            "   gl_FragColor = vec4((1.0 - outputMono.rgb), outputMono.w);\n" +
            "  }";
    ...
    public GPUImageInvertMonochromeFilter() {
        this(1.0f, new float[]{0.6f, 0.45f, 0.3f, 1.0f});
    }

    public GPUImageInvertMonochromeFilter(final float intensity, final float[] color) {
