...
object GPUImageFilterTools {
    fun showDialog(
        ...
        val filters = FilterList().apply {
            ...
            addFilter("Invert Grayscale", FilterType.INVERT_GRAYSCALE)
            ...
            addFilter("Invert Monochrome", FilterType.INVERT_MONOCHROME)
    ...
    private fun createFilterForType(context: Context, type: FilterType): GPUImageFilter {
        return when (type) {
            ...
            FilterType.INVERT_GRAYSCALE -> GPUImageInvertGrayscaleFilter()
            ...
            FilterType.INVERT_MONOCHROME -> GPUImageInvertMonochromeFilter(
                    1.0f, floatArrayOf(0.6f, 0.45f, 0.3f, 1.0f)
            )
    ...
    private enum class FilterType {
        CONTRAST, GRAYSCALE, INVERT_GRAYSCALE, SHARPEN, SEPIA, SOBEL_EDGE_DETECTION, THRESHOLD_EDGE_DETECTION, THREE_X_THREE_CONVOLUTION, FILTER_GROUP, EMBOSS, POSTERIZE, GAMMA, BRIGHTNESS, INVERT, HUE, PIXELATION,
        SATURATION, EXPOSURE, HIGHLIGHT_SHADOW, MONOCHROME, INVERT_MONOCHROME, OPACITY, RGB, WHITE_BALANCE, VIGNETTE, TONE_CURVE, LUMINANCE, LUMINANCE_THRESHSOLD, BLEND_COLOR_BURN, BLEND_COLOR_DODGE, BLEND_DARKEN,
